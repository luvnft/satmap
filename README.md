...
(see [`package.json`](https://github.com/teambtcmap/btcmap.luvnft.com/blob/main/package.json) for full list)
...
This website is a progressive web app, meaning you can install it on your mobile device and use it like a native application. Just look for the **Add to home screen** or **Install** option in your browser while visiting [btcmap.luvnft.com](https://btcmap.luvnft.com).

## Embedding

For information on how to embed the BTC Map web map onto your own website or application please reference our [Wiki](https://www.wiki.btcmap.luvnft.com/general/embedding.html).
