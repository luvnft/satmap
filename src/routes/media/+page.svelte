<script lang="ts">
	...
	const brandColors = ['#10B981', '#000000', '#051173', '#0891B2', '#E4EBEC', '#164E63', '#155E75'];
	...
	const brand = [
		...
		{ link: '/images/supertagger-king.png', name: 'Shadowy Supertagger - Leader' }
	];
...
<div class="bg-teal dark:bg-dark">
	...
	<div class="mx-auto w-10/12 xl:w-[1200px]">
		<main class="mb-20 mt-10 space-y-10 text-center text-primary dark:text-white">
